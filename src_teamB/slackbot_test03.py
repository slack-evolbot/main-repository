...
try:
    while True:
        ...
        if(os.path.exists("/home/pi/teamB/SLACK_BOT_CH_NO.txt")):
            file = open("/home/pi/teamB/SLACK_BOT_CH_NO.txt")
            fileLine = file.readline().replace('\r|\n|\r\n',"")
            
            if(fileLine != ""):
                codeIR = ['0']
                codeIR[0]=fileLine
                os.remove("/home/pi/teamB/SLACK_BOT_CH_NO.txt")
            ...
            if result.is_valid():
                ...
                if(codeIR[0]=="0"):
                    ...
                    for i in range(5):
                        ...
                        toral_Number = total_Number + disp_Number
                        print_disp(str(disp_number),"")
                        sleep(1)
