...
try:
    while True:
        ...
        if((oldCodeIR!=codeIR and codeIR !=[]) or oldCodeIR=="1"):
            ...
            if(dateFlg):
                strDate = time.strftime("%Y.%m.%d", time.gmtime())
            else:
                strDate = ""

            if(codeIR[0]!="prev" or codeIR[0]!="next" or codeIR[0]!="CH+" or codeIR[0]!="CH-"):
                oldCodeIR=codeIR[0]
            ...
            if result.is_valid():
                ...
                if(codeIR[0]=="0"):
                    ...
                    disp_test01.print_disp("CH"+str(codeIR[0]),"LCHIKA TEST")
                    ...
                    disp_test01.print_disp("CH"+str(codeIR[0])+" "+strDate,"")

                elif(codeIR[0]=="3"):
                    disp_test01.print_disp("CH"+str(codeIR[0])+" "+strDate,str(result.temperature)+"C")

                elif(codeIR[0]=="4"):
                    disp_test01.print_disp("CH"+str(codeIR[0])+" "+strDate,str(result.humidity)+"%")

                elif(codeIR[0]=="5"):
                    disp_test01.print_disp("CH"+str(codeIR[0])+" "+strDate,str(sensor.read_pressure())+"Pa")

                elif(codeIR[0]=="6"):
                    disp_test01.print_disp("CH"+str(codeIR[0])+" "+strDate,str(result.temperature)+"C "+str(result.humidity)+"%")

                elif(codeIR[0]=="7"):
                    disp_test01.print_disp("CH"+str(codeIR[0])+" "+strDate,str(result.temperature)+"C "+str(sensor.read_pressure())+"Pa")

                elif(codeIR[0]=="8"):
                    disp_test01.print_disp("CH"+str(codeIR[0])+" "+strDate,str(result.humidity)+"% "+str(sensor.read_pressure())+"Pa")

                elif(codeIR[0]=="9"):
                    disp_test01.print_disp("CH"+str(codeIR[0])+" "+strDate,str(result.temperature)+"C "+str(result.humidity)+"% "+str(sensor.read_pressure())+"Pa")
